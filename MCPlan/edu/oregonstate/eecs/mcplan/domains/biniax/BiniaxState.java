...
/**
 * Defines a Biniax state. Location value representation: -1: impassable 0:
 * empty x: single element 0 < x <= MAX_ELEMENTS xy: element pair 0 < x <=
 * MAX_ELEMENTS and 0 < y <= MAX_ELEMENTS and x < y
 */
